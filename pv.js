...
//						+ 	'<tr><td class="grey" colspan=1></tr></td>'
						...
						+ 	'</tr>'
						+	'<tr>'
						+		'<td class="white">Tel: +1-721-542-2222 Ext 185/186</td>'
						+ 	'</tr>'	
						+ '</table>'
						+ '<br><br><br>;'						;
...
if 	(array['cctv'] == "CCTV Gecertificeerd") {
	...
	content = content 	+ ' '
						...
						+ 	'<p>'
						+ 	'Op ' + datumaanvraagStr + '  kreeg ik, verbalisant, het verzoek van ' + capitalizeFirstLetter( array['naam'] ) + ' van KPSM, om te assisteren bij het onderzoek van een ' + capitalizeFirstLetter( array['SoortGoed'] ) + ', in verband met het onderzoek ' + capitalizeFirstLetter( array['naamonderzoek'] ) + ', in behandeling bij de afdeling ' + capitalizeFirstLetter( array['aanvraagafd'] ) + '.'
						+ '<p>'
...
if	(array['SoortGoed'] == "Smartphone met Simkaart en microSD") {
	content = content 	+ '<table width="100%">'
						+ 	'<tr>'
						+ 		'<td class="grey"  width="20%">SoortGoed </td>'
						+ 		'<td>' + capitalizeFirstLetter ( array['SoortGoed'] ) + '</td>'
						+ 	'</tr>'
						+ 	'<tr>'
						+ 		'<td class="grey"  width="20%">merkgoed </td>'
						...
						+ 	'</tr>'
						+ 	'<tr>'
						+		'<td class="grey" width="20%">telco </td>'
